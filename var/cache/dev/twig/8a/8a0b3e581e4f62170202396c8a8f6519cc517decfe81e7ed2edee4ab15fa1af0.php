...
class __TwigTemplate_6928489635157f3ca7298a5d6f22827ff2526a115d1acf7efa4a4d148c9ddea7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_dernek_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger btn-lg\">Delete</button>
</form>
", "user/_delete_form.html.twig", "C:\\xampp\\htdocs\\mysite\\templates\\user\\_delete_form.html.twig");
    }
}
