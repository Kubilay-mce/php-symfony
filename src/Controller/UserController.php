...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/ilanlar", name="user_ilanlar", methods={"GET"})
     */
    public function ilanlar(DernekRepository $dernekRepository): Response
    {
        return $this->render('user/ilanlar.html.twig', [
